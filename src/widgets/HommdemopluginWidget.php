...
namespace homm\hommdemoplugin\widgets;

use homm\hommdemoplugin\Hommdemoplugin;
use homm\hommdemoplugin\assetbundles\hommdemopluginwidgetwidget\HommdemopluginWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * hommdemoplugin Widget
 *
 ...
 * @since     0.0.1
 */
class HommdemopluginWidget extends Widget
{
    ...
    {
        return Craft::t('hommdemoplugin', 'HommdemopluginWidget');
    }
    ...
    {
        return Craft::getAlias("@homm/hommdemoplugin/assetbundles/hommdemopluginwidgetwidget/dist/img/HommdemopluginWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'hommdemoplugin/_components/widgets/HommdemopluginWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(HommdemopluginWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'hommdemoplugin/_components/widgets/HommdemopluginWidget_body',
            [
